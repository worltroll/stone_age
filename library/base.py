import arcade
from arcade.gui import UIManager, UITextureButton, UITextArea, UILabel
...
class Launcher(arcade.Window):
    def __init__(self, width, height, title):
        ...
        self.button_normal_texture = arcade.load_texture('../images/button.png')
        self.button_pressed_texture = arcade.load_texture('../images/button_pressed.png')
    def setup(self):
    ...
    def setup_widgets(self):
        wortroll_label = UITextArea(text='Wortroll \n games', x=900, y=650, font_size=50, font_name='arial', text_color=arcade.color.RED, width=300, height=200)
        ...
        button_main1 = UITextureButton(texture=button_normal_texture, texture_pressed=button_pressed_texture, width=400, height=80, text='Начать игру')
        button_main2 = UITextureButton(texture=button_normal_texture, texture_pressed=button_pressed_texture, width=200,
                                       height=80, text='ЗАКРЫТЬ')
        button = UITextureButton(texture=button_normal_texture, texture_pressed=button_pressed_texture, width=300, height=80, text='ДОНАТ 10 РУБЛЕЙ')
        button1 = UITextureButton(texture=button_normal_texture, texture_pressed=button_pressed_texture,
                                 width=300, height=80, text='ДОНАТ 100 РУБЛЕЙ')
        button2 = UITextureButton(texture=button_normal_texture, texture_pressed=button_pressed_texture,
                                 width=300, height=80, text='ДОНАТ 1000 РУБЛЕЙ')
        button3 = UITextureButton(texture=button_normal_texture, texture_pressed=button_pressed_texture,
